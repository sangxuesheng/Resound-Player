<template>
  <transition name="player-sheet">
    ...
    >
      ...
      <section class="expanded-panel" :class="{ 'comments-panel-open': showComments }">
        ...
        <div class="panel-body" :style="panelBodyStyle">
          ...
          <div v-else class="comments-overlay">
...
.expanded-panel.comments-panel-open { padding-bottom: 0; gap: 0; grid-template-rows: 0 1fr auto; }
