    ...
    >
      ...
      <section class="expanded-panel">
        <AnimatedAppear tag="header" variant="content" rhythm="head" class-name="panel-head">
          ...
          <AnimatedAppear tag="button" variant="control" rhythm="actions" :index="1" class-name="ghost" @click="toggleDisplayMode">{{ lyricsSettings.displayMode === 'fullscreen' ? '退出全屏' : '全屏' }}</AnimatedAppear>
        </AnimatedAppear>
...
function toggleDisplayMode() {
  lyricsSettings.displayMode = lyricsSettings.displayMode === 'fullscreen' ? 'cover' : 'fullscreen';
  lyricsSettings.save();
}
