...
.ghost { height: 32px; border-radius: 10px; border: 1px solid var(--border-soft); background: transparent; color: var(--text-sub); padding: 0 var(--space-3); cursor: pointer; font-size: 13px; flex-shrink: 0; transition: all 0.12s ease; }
